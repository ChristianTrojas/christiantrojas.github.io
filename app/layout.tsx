  ...
  return (
    <html lang="en">
      <head>
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600&family=Merriweather:wght@400;700&display=swap"
          rel="stylesheet"
        />
        <link
          ...
          rel="stylesheet"
        />
        <meta name="theme-color" content="#4B6E91" />
      </head>
      <body className="font-sans bg-soft text-graphite">
        {children}
        <Script
